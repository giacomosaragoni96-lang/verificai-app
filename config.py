...
# ── TEMI UI — 2 temi ───────────────────────────────────────────────────────────
# "chiaro" è il predefinito (Arctic). "scuro" è Midnight Blue.
THEMES = {
    # 1. Chiaro — basato su Arctic, predefinito all'avvio
    "chiaro": {
        "bg":           "#EAF3FB",
        "bg2":          "#FFFFFF",
        "card":         "#FFFFFF",
        ...
        "shadow_md":    "0 4px 12px rgba(2,132,199,.12)",
        "input_bg":     "#F4F9FD",
        "hover":        "#DFF0FA",
        # Colori hint espliciti (per leggibilità su fondo chiaro)
        "hint_bg":      "#DBEEFF",
        "hint_text":    "#1A4A70",
        "hint_border":  "#90C4E0",
    },
    # 2. Scuro — basato su Midnight Blue
    "scuro": {
        "bg":           "#0F172A",
        "bg2":          "#1E293B",
        "card":         "#1E293B",
        ...
        "input_bg":     "#253047",
        "hover":        "#2D3F5C",
        # Colori hint (per coerenza con il tema scuro)
        "hint_bg":      "#29220F",
        "hint_text":    "#FDE68A",
        "hint_border":  "#78450A",
    },
