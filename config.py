...
THEMES = {
    ...
    # ═══════════════════════════════════════════════════════════════════════
    #  OCEANO — Deep Navy Blue  (profondo · fresco · concentrazione)
    # ═══════════════════════════════════════════════════════════════════════
    "oceano": {
        "bg":         "#0A1628",
        "bg2":        "#0F2040",
        ...
        "shadow_md":  "0 4px 24px rgba(0,0,0,.60)",
        "shadow_soft": "0 8px 32px rgba(0,0,0,.60), 0 2px 8px rgba(0,0,0,.30)",
        "radius_sm":  "8px",
        "radius_md":  "12px",
        "radius_lg":  "16px",
        "sidebar_bg":       "linear-gradient(180deg, #060F1E 0%, #0A1628 100%)",
        "sidebar_border":   "#1E3A5F",
        "sidebar_accent":   "#38BDF8",
        "sidebar_input_bg":  "#0F2040",
        "sidebar_input_text": "#E2EEF9",
        "hint_bg":      "#082035",
        "hint_border":  "#0F3A5A",
        "hint_text":    "#38BDF8",
    },
    ...
    # ═══════════════════════════════════════════════════════════════════════
    #  FORESTA — Deep Forest Green  (organico · calmo · natura)
    # ═══════════════════════════════════════════════════════════════════════
    "foresta": {
        "bg":         "#0C1E12",
        "bg2":        "#122518",
        ...
        "radius_md":  "12px",
        "radius_lg":  "16px",
        "sidebar_bg":       "linear-gradient(180deg, #07100A 0%, #0C1E12 100%)",
        "sidebar_border":   "#1E4030",
        "sidebar_accent":   "#4ADE80",
        "sidebar_input_bg":  "#122518",
        "sidebar_input_text": "#E0F2EA",
        "hint_bg":      "#0C2015",
        "hint_border":  "#1A4028",
        "hint_text":    "#4ADE80",
    },
    ...
    # ═══════════════════════════════════════════════════════════════════════
    #  TRAMONTO — Warm Sunset  (calore · energia · arancio dorato)
    # ═══════════════════════════════════════════════════════════════════════
    "tramonto": {
        "bg":         "#1A0D05",
        "bg2":        "#22140A",
        ...
        "radius_md":  "12px",
        "radius_lg":  "16px",
        "sidebar_bg":       "linear-gradient(180deg, #100805 0%, #1A0D05 100%)",
        "sidebar_border":   "#3A2010",
        "sidebar_accent":   "#FB923C",
        "sidebar_input_bg":  "#22140A",
        "sidebar_input_text": "#FAE5CC",
        "hint_bg":      "#201008",
        "hint_border":  "#3A2010",
        "hint_text":    "#FB923C",
    },
    ...
    # ═══════════════════════════════════════════════════════════════════════
    #  NEBBIA — Cool Slate Mist  (moderno · neutro · professionale)
    # ═══════════════════════════════════════════════════════════════════════
    "nebbia": {
        "bg":         "#161C2C",
        "bg2":        "#1E2538",
        ...
        "radius_md":  "12px",
        "radius_lg":  "16px",
        "sidebar_bg":       "linear-gradient(180deg, #0E1220 0%, #161C2C 100%)",
        "sidebar_border":   "#2A3550",
        "sidebar_accent":   "#94A3B8",
        "sidebar_input_bg":  "#1E2538",
        "sidebar_input_text": "#CDD7E9",
        "hint_bg":      "#1A2030",
        "hint_border":  "#2A3550",
        "hint_text":    "#94A3B8",
    },
    ...
    # ═══════════════════════════════════════════════════════════════════════
    #  LAVANDA — Deep Violet  (creativo · etereo · elegante)
    # ═══════════════════════════════════════════════════════════════════════
    "lavanda": {
        "bg":         "#14102A",
        "bg2":        "#1C1838",
        ...
        "radius_md":  "12px",
        "radius_lg":  "16px",
        "sidebar_bg":       "linear-gradient(180deg, #0D0918 0%, #14102A 100%)",
        "sidebar_border":   "#2E2850",
        "sidebar_accent":   "#A78BFA",
        "sidebar_input_bg":  "#1C1838",
        "sidebar_input_text": "#EDE8FF",
        "hint_bg":      "#18102E",
        "hint_border":  "#2E2850",
        "hint_text":    "#A78BFA",
    },
    ...
    # ═══════════════════════════════════════════════════════════════════════
    #  MOGANO — Deep Mahogany Red  (caldo · maturo · deciso)
    # ═══════════════════════════════════════════════════════════════════════
    "mogano": {
        "bg":         "#160808",
        "bg2":        "#1E0E0E",
        ...
        "radius_md":  "12px",
        "radius_lg":  "16px",
        "sidebar_bg":       "linear-gradient(180deg, #0E0505 0%, #160808 100%)",
        "sidebar_border":   "#341515",
        "sidebar_accent":   "#F87171",
        "sidebar_input_bg":  "#1E0E0E",
        "sidebar_input_text": "#FAE0E0",
        "hint_bg":      "#1A0808",
        "hint_border":  "#341515",
        "hint_text":    "#F87171",
    },
    ...
    # ═══════════════════════════════════════════════════════════════════════
    #  BRONZO — Warm Amber  (dorato · prezioso · antico)
    # ═══════════════════════════════════════════════════════════════════════
    "bronzo": {
        "bg":         "#150E03",
        "bg2":        "#1E1504",
        ...
        "radius_md":  "12px",
        "radius_lg":  "16px",
        "sidebar_bg":       "linear-gradient(180deg, #0D0902 0%, #150E03 100%)",
        "sidebar_border":   "#342208",
        "sidebar_accent":   "#D97706",
        "sidebar_input_bg":  "#1E1504",
        "sidebar_input_text": "#FAF0D0",
        "hint_bg":      "#180E02",
        "hint_border":  "#342208",
        "hint_text":    "#D97706",
    },
    ...
    # ═══════════════════════════════════════════════════════════════════════
    #  SALVIA — Sage Green  (quieto · botanico · zen)
    # ═══════════════════════════════════════════════════════════════════════
    "salvia": {
        "bg":         "#0A1812",
        "bg2":        "#102018",
        ...
        "radius_md":  "12px",
        "radius_lg":  "16px",
        "sidebar_bg":       "linear-gradient(180deg, #060E0A 0%, #0A1812 100%)",
        "sidebar_border":   "#1C3020",
        "sidebar_accent":   "#6EE7B7",
        "sidebar_input_bg":  "#102018",
        "sidebar_input_text": "#D8F0E8",
        "hint_bg":      "#0E1E16",
        "hint_border":  "#1C3020",
        "hint_text":    "#6EE7B7",
    },
    ...
    # ═══════════════════════════════════════════════════════════════════════
    #  AMETISTA — Deep Amethyst  (magico · intenso · creativo)
    # ═══════════════════════════════════════════════════════════════════════
    "ametista": {
        "bg":         "#0F0818",
        "bg2":        "#160C22",
        ...
        "radius_md":  "12px",
        "radius_lg":  "16px",
        "sidebar_bg":       "linear-gradient(180deg, #08050F 0%, #0F0818 100%)",
        "sidebar_border":   "#221235",
        "sidebar_accent":   "#E879F9",
        "sidebar_input_bg":  "#160C22",
        "sidebar_input_text": "#F8E8FF",
        "hint_bg":      "#120A1C",
        "hint_border":  "#221235",
        "hint_text":    "#E879F9",
    },
    ...
    # ═══════════════════════════════════════════════════════════════════════
    #  ARDESIA — Steel Slate  (preciso · tecnologico · urbano)
    # ═══════════════════════════════════════════════════════════════════════
    "ardesia": {
        "bg":         "#1A2030",
        "bg2":        "#222A3E",
        ...
        "radius_md":  "12px",
        "radius_lg":  "16px",
        "sidebar_bg":       "linear-gradient(180deg, #111820 0%, #1A2030 100%)",
        "sidebar_border":   "#2E3C58",
        "sidebar_accent":   "#60A5FA",
        "sidebar_input_bg":  "#222A3E",
        "sidebar_input_text": "#D0D8EE",
        "hint_bg":      "#1A2540",
        "hint_border":  "#2E3C58",
        "hint_text":    "#60A5FA",
    },
