"""
Sidebar originale di backup - funzione render_sidebar semplificata
Versione senza componente Stripe per evitare problemi temporanei
"""

import streamlit as st
import logging
from config import LIMITE_MENSILE
